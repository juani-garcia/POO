...
public class MathFunctionIntervalTester {
    public static void main(String[] args) {
        ...
        MathFunctionInterval<Integer> integerInterval = new MathFunctionInterval<>(1, 10, stepTwo);
        for (int element : integerInterval){ // Imprime 1 3 5 7 9
            System.out.println(element);
        }

        // Ejemplo 2: Intervalo de numeros reales (Double)
        // De 1 a 10 con paso 2.5
        MathFunctionInterval<Double> doubleInterval = new MathFunctionInterval<>(1.0, 10.0, new MathFunction<Double>() {
            @Override
        ...
        // De 1 a 110 con paso 2.5
        MathFunctionInterval<FloatWrapper> floatWrapperInterval = new MathFunctionInterval<>(new FloatWrapper(1f), new FloatWrapper(10f), new MathFunction<FloatWrapper>() {
            @Override
        ...
        // Ejemplo 4: Solo debe funcionar con start < end
        try {
        ...
        // De 1 a 10 con paso -1 generara un intervalo infinito
        // y no es necesario validarlo
        /*MathFunctionInterval<Integer> wrongInterval = new MathFunctionInterval<>(1, 10, x -> x - 1);
